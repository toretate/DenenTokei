...
public class WidgetLayoutInfo {
    ...
    public static final @NonNull String DEF_FONT_FAMILY = "serif";
	...
	public WidgetTextLayoutInfo getTextLayoutInfo( FontSetting.FontSettingType type ) {
		return type == FontSettingType.Sta ? m_staInfo : m_chaInfo;
	}
